...
#define BLOCK_NUM 70 //GTX 1060 - 81, T4 - 320, P100 - , V100 - 640
#define GRID_THREAD_SIZE (THREAD_PER_BLOCK * BLOCK_NUM)
#define MAX_SPACE_PER_THREAD 64 //NOTE: THIS Need to be multiple of 4 because of indexing //For other -64, For V100 -16
...
//MITM Criteria
#define MAX_ROUND_FORWARD 7 //For NON MITM, use MAX_ROUND_FORWARD
#define MAX_ROUND_BACKWARD 6
// #define MAX_ROUND (MAX_ROUND_FORWARD+MAX_ROUND_BACKWARD)

//Pruning Criteria3
#define MAX_AS 4
// Cluster Bound is optimized for TRIFLE
const float CLUSTER_PROB_BOUND = (pow(2, -75)); 
const float CLUSTER_PROB_BOUND_FORWARD = (pow(2, -75)); 
const float CLUSTER_PROB_BOUND_BACKWARD = (pow(2, -75)); 
...
namespace SPN_DIFF{
	...
	*/
    ...
    extern unsigned int diff_table_host[][8]; //There can ever be 8 maximum diff pattern for 4 bit s-boxes
...
struct GPU_Kenerl_t{
    ...
    //Input / Intermediate
    // int* device_total_branch_size; // (<= MAX_PATH_PER_ROUND * MAX_ROUND_FORWARD)
